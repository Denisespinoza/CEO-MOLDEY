  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-navy-800 dark:text-white">Panel CEO MOLDEY</h1>
          <p className="text-sm text-carbon-400 dark:text-carbon-400 mt-1">Centro de Operaciones Moldey</p>
        </div>
