...
const WELCOME_MESSAGE: AiChatMessage = {
  role: 'assistant',
  content: 'Hola, soy Kairos, el Asistente Operativo de CEO Moldey. Puedo ayudarte a redactar mensajes, armar descripciones comerciales, ordenar pedidos, calcular precios simples y preparar resúmenes con datos de solo lectura del sistema.',
};
      ...
      <div className="relative overflow-hidden rounded-2xl border border-teal-400/20 bg-slate-900/80 p-4 shadow-2xl shadow-teal-950/30">
        ...
        <div className="relative flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-gold-400/80">CEO Moldey</p>
