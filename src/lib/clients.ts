...
export function formatWhatsAppMessage(order: Order, clientName: string): string {
  ...
  return `Hola ${clientName}, te escribimos de CEO MOLDEY por tu pedido: ${article}.
...
CEO MOLDEY - Centro de Operaciones Moldey`;
}
...
export const WHATSAPP_TEMPLATES = {
  paymentReminder: (orderNumber: string, balance: number) =>
    `Hola, te recordamos que tu pedido *${orderNumber}* tiene un saldo pendiente de *$${balance.toLocaleString('es-AR')}*. - CEO MOLDEY`,
};
