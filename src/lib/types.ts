...
export interface OrderItem {
  garment_type: string;   // molde / código
  article_name: string;
  sizes: string;
  quantity: number;
  fabric_type: string;
...
// Grupos de talles para selección rápida (pedidos e inventario)
export const SIZE_GROUPS: { label: string; emoji: string; sizes: string }[] = [
  // Grupos completos
  { label: 'Bebés',   emoji: '👶', sizes: '1/2/3/4/5/6/7/8/9' },
  { label: 'Niños',   emoji: '🧒', sizes: '2/4/6/8/10/12/14/16/18' },
  { label: 'Adultos', emoji: '🧑', sizes: 'XS/S/M/L/XL/2XL/3XL/4XL' },
  // Grupos acotados
  { label: 'S-2XL',  emoji: '🧑', sizes: 'S/M/L/XL/2XL' },
  { label: 'M-3XL',  emoji: '🧑', sizes: 'M/L/XL/2XL/3XL' },
  { label: '4-16',   emoji: '🧒', sizes: '4/6/8/10/12/14/16' },
  { label: '1-6',    emoji: '👶', sizes: '1/2/3/4/5/6' },
];
